...
pub mod enable_bpf_v2_entrypoint {
    solana_pubkey::declare_id!("V2Entry1111111111111111111111111111111111111");
}
...
pub static FEATURE_NAMES: LazyLock<AHashMap<Pubkey, &'static str>> = LazyLock::new(|| {
    [
        ...
        (enable_bpf_v2_entrypoint::id(), "Enable BPF v2 entrypoint with additional metadata"),
