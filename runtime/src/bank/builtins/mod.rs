...
// Configs used to test core BPF migration.
#[cfg(test)]
pub(crate) mod test_only {
    ...
    pub mod system_program {
        ...
        pub const CONFIG: CoreBpfMigrationConfig = CoreBpfMigrationConfig {
            source_program_id: source_program::id(),
            feature_id: feature::id(),
            migration_target: CoreBpfMigrationTargetType::Builtin,
            datapoint_name: "core_bpf_migration_feature_gate_program",
        };
    }
