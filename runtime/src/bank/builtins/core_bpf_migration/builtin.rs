...
mod tests {
    ...
    #[test_case(solana_sdk::bpf_loader::id(), CoreBpfMigration::Builtin, None)]
    #[test_case(
    ...
    #[test_case(solana_sdk::compute_budget::id(), CoreBpfMigration::Builtin, None)]
    #[test_case(solana_config_program::id(), CoreBpfMigration::Builtin, None)]
    #[test_case(solana_stake_program::id(), CoreBpfMigration::Builtin, None)]
    #[test_case(solana_system_program::id(), CoreBpfMigration::Builtin, None)]
    #[test_case(solana_vote_program::id(), CoreBpfMigration::Builtin, None)]
    #[test_case(
    ...
    fn test_builtin_config_builtin(
    ...
    fn test_builtin_config_ephemeral_builtin(program_address: Pubkey, migration: CoreBpfMigration) {
