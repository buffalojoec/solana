...
mod tests {
    ...
    #[test_case(solana_sdk::bpf_loader::id(), CoreBpfMigration::Builtin)]
    #[test_case(solana_sdk::bpf_loader_deprecated::id(), CoreBpfMigration::Builtin)]
    #[test_case(solana_sdk::bpf_loader_upgradeable::id(), CoreBpfMigration::Builtin)]
    #[test_case(solana_sdk::compute_budget::id(), CoreBpfMigration::Builtin)]
    #[test_case(solana_config_program::id(), CoreBpfMigration::Builtin)]
    #[test_case(solana_stake_program::id(), CoreBpfMigration::Builtin)]
    #[test_case(solana_system_program::id(), CoreBpfMigration::Builtin)]
    #[test_case(solana_vote_program::id(), CoreBpfMigration::Builtin)]
    fn test_builtin_config_existing_builtins(program_address: Pubkey, migration: CoreBpfMigration) {
        ...
        let program_account: Account = bank
            ...
            .unwrap()
            .into();
        let program_data_address = get_program_data_address(&program_address).0;
    ...
    #[test_case(solana_sdk::feature::id(), CoreBpfMigration::Ephemeral)]
    #[test_case(solana_sdk::native_loader::id(), CoreBpfMigration::Ephemeral)]
    fn test_builtin_config_ephemeral_builtins(
    ...
    fn test_builtin_config_features_enabled(
        program_address: Pubkey,
        migration: CoreBpfMigration,
        activation_feature: Pubkey,
    ) {
        ...
        let builtin_config =
            BuiltinConfig::new_checked(&bank, &program_address, migration).unwrap();
