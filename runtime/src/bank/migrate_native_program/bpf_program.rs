use {
    ...
    solana_sdk::{
        ...
        feature_set::disable_bpf_loader_instructions, pubkey::Pubkey,
    },
};
...
impl BpfProgramConfig {
    ...
    pub fn new_checked(bank: &Bank, address: &Pubkey) -> Result<Self, MigrateNativeProgramError> {
        ...
        // Feature `disable_bpf_loader_instructions` will cause this check to
        // fail for new BPF programs.
...
mod tests {
    ...
    fn test_bpf_program_config() {
        ...
        assert_matches!(
            BpfProgramConfig::new_checked(&bank, &program_id).unwrap_err(),
