    ...
    match stake_instruction {
        ...
        StakeInstruction::DelegateStake => {
            ...
            delegate(
                ...
                &stake_history,
                &signers,
                &invoke_context.runtime_context.feature_set,
            )
        }
        ...
        StakeInstruction::GetMinimumDelegation => {
            let feature_set = invoke_context.runtime_context.feature_set.as_ref();
...
mod tests {
    ...
    fn process_instruction(
        ...
        mock_process_instruction(
            ...
            Entrypoint::vm,
            |invoke_context| {
                invoke_context.runtime_context.feature_set = Arc::clone(&feature_set);
            },
            |_invoke_context| {},
        )
    }
        ...
        mock_process_instruction(
            ...
            |invoke_context| {
                let expected_minimum_delegation =
                    crate::get_minimum_delegation(&invoke_context.runtime_context.feature_set)
                        .to_le_bytes();
