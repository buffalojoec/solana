...
pub trait SyscallStubs: Sync + Send {
    ...
    fn sol_syscall_get_latest_blockhash(&self, _var_addr: *mut u8) -> u64 {
        UNSUPPORTED_SYSVAR
    }
    /// # Safety
...
pub(crate) fn sol_syscall_get_latest_blockhash(var_addr: *mut u8) -> u64 {
    SYSCALL_STUBS
        .read()
        .unwrap()
        .sol_syscall_get_latest_blockhash(var_addr)
}
